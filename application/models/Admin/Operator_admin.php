...
class Operator_admin extends Admin {
	function __construct(){
		parent::__construct();
		$this->layout       = "admin/layout/operator/";
        $this->component    = "component/operator/";
	}
    function dashboard(){
    ...
    function user(){
        ...
        $users  =   $this->user->query("select distinct user.*, company_name from user, company where user.company_id = company.id and company_id <> -1");
