...
class Supervisor_admin extends Admin {
	function __construct(){
		parent::__construct();
		$this->layout         =   "admin/layout/supervisor/";
        $this->component    = "component/supervisor/";
	}
    function map(){
        return array(
    ...
    function shop(){
        ...
        $shops = $this->shop->get_supervisor_shop($this->user->get_user_info()->group_user_id);
