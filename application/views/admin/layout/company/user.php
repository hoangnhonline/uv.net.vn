            ...
            <div class="box box-warning">
                <form action="<?php echo base_url("admin/action/add/user") ?>" class="form-horizontal" method="post">
                    <div class="box-body ">
                        ...
                        <div class="form-group">
                            <label class="controller-label col-sm-3 text-right">Group</label>
                            <div class="col-sm-9">
                ...
                <form action="<?php echo base_url("admin/action/update/user") ?>" class="form-horizontal" method="post">
                    <div class="box-body ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="fullname" placeholder="Nguyen Van Nam" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="controller-label col-sm-3 text-right">Email</label>
                            <div class="col-sm-9">
                                <input type="email" class="form-control" name="email" placeholder="google@gmail.com" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="controller-label col-sm-3 text-right">Phone</label>
                            <div class="col-sm-9">
                                <input type="tel" class="form-control" name="phone" placeholder="01267767777" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="controller-label col-sm-3 text-right">Group</label>
...
<script type="text/javascript">
    ...
    var usernames = {
        <?php foreach ($users as $key => $value) {
            ?> <?php echo $key ?> : "<?php echo $value->username; ?>",
            <?php
        } ?>
    };
    ...
    $(document).ready(function(){
        ...
        $("p.help-block").hide();
        $("#modal-add input[name='username']").change(function(){
            for(var key in usernames){
                if($(this).val() == usernames[key]){
                    $("p.help-block").show();
                    $(this).val("");
                } else {
                    $("p.help-block").hide();
        ...
        $group_user_id = $("#modal-edit select[name='group_user_id']");
            ...
            $.ajax({
                ...
                success: function(html){
                    try{
                        ...
                        $group_user_id.find("option").each(function(){
                            if($(this).attr("value") == data.user_info[0].group_user_id){
