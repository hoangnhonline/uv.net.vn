                    ...
                    <form class="box-body" action="#" method="post">
                        <table id="table" class="table table-bordered table-striped">
                            <thead>
                                ...
                                <th style="text-align: left; padding: 8px">FTP Host</th>
            ...
            <div class="box box-warning">
                <form action="<?php echo base_url("admin/action/add/company") ?>" class="form-horizontal" method="post">
                    <div class="box-body ">
                        ...
                        <div class="form-group">
                            <label class="controller-label col-sm-3 text-right">Ftp host</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="ftp_host" required>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <form action="<?php echo base_url("admin/action/update/company") ?>" class="form-horizontal" method="post">
                    <div class="box-body ">
                        ...
                        <div class="form-group">
                            <label class="controller-label col-sm-3 text-right">Ftp host</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="ftp_host" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="controller-label col-sm-3 text-right">Ftp name</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="ftp_name" value="admin">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="controller-label col-sm-3 text-right">Ftp pass</label>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $ftp_host = $modal_edit.find("input[name='ftp_host']");
                ...
                success     :   function(html){
                    try{
                        ...
                        try {
                            ...
                            $ftp_host.val(data.company_info[0].ftp_host);
                        } catch (ex) {
